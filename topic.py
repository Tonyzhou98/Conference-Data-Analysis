...
def topic_classification_gensim(filename_1, filename_2):
    idf_1 = idf_list("idf/idf93-95.txt")
    idf_2 = idf_list("idf/idf14-16.txt")
    common_texts = []
    ...
    for index, topic in lda.show_topics(formatted=False, num_words=20, num_topics=35):
    ...
    '''
    topic_14 = [0.00 for n in range(35)]
    topic_11 = [0.00 for n in range(35)]
...
def main():
    ...
    topic_classification_gensim('word/word93-95.txt', 'word/word14-16.txt')
    '''
    topic_classification('word90-92.txt')
