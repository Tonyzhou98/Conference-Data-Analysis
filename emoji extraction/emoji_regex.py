...
def find_emoji(all_emoji_regex, emoji_dict):
    ...
    justdoit_emoji_freq['group'] = [emoji_dict[word].group if word != '️' else '' for word in
                                    justdoit_emoji_freq['word']]
    justdoit_emoji_freq['sub_group'] = [emoji_dict[word].sub_group if word != '️' else '' for word in
                                        justdoit_emoji_freq['word']]
